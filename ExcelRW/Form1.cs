...
namespace ExcelRW
{
    public partial class Form1 : Form
    {
        ...
        {
            ReadExcelFile("e:\\Download\\네이버가계부_지출현황_201812_욱진.xls");
        }

        public void MS_Sample()
        {
            // https://support.microsoft.com/ko-kr/help/302084/how-to-automate-microsoft-excel-from-microsoft-visual-c-net
        ...
        public void ReadExcelFile(string path) 
        {
            ...
            try
            {
                ...
                for (int row = 1; row <= oRng.Rows.Count; row++)
                {
